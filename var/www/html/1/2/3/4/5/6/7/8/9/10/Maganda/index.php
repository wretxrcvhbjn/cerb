                ...
                <div class="block-content block-content-full px-lg-5 px-xl-6 py-4 py-md-5 py-lg-6 bg-white">
                    ...
                    <div class="mb-2 text-center">
                        <a class="link-fx font-w700 font-size-h1">
                            <span class="text-dark">MaGan</span><span class="text-primary">nDa</span>
                        </a>
                    ...
                    <form class="js-validation-signin" action="login.php" method="POST">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <input type="password" class="form-control" id="sifre" name="pass" placeholder="Password">
                                <div class="input-group-append">
                                    <span class="input-group-text">
                        ...
                        <div class="form-group text-center">
                            <button type="submit" value="Giriş" class="btn btn-hero-primary">
